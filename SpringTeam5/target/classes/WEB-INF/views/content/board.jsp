...
<body>
	...
	<!-- header -->
	<input type="button" value="글쓰기" style="float:right" onClick="./BoardWrite.do">
	<h4 align="left">게시판목록</h4>
	<table border=1 width="300" height="500" align="center">
		...
		[${i}]	
				...
				<!-- 다음 블럭 이동 -->
				<c:if test="${EndPage < listcount}">
					<a href="./BoardList.do?page=${StartPage+10}"> [다음] </a>
				</c:if>

				<!-- 마지막 페이지 이동-->
				<a href="./BoardList.do?page=${listcount}" style="text-decoration: none">
					>> </a>
			</c:if>
			<!-- 검색 -->
			<form>
