...
<script src="resources/content/naverMember.js?var=1"></script>
<style>
#hed {
		...
		<div class="container" id="hed">
			...
			<div class="form-group ">
					...
					<div class="input-group">
						...
						</span> <input type="text" id="mem_id" name="mem_id" class="form-control" value="${member.mem_id}"  readonly >	
				...
				<!--비밀번호 입력 및 다시 확인  -->
					...
					<div class="input-group">
						<span class="input-group-addon"> <i
							class="glyphicon glyphicon-user"></i>
						</span> <input type="text" id="mem_name" name="mem_name" value="${member.mem_name}" class="form-control">
					</div>
				</div>
				<div class="form-group">
